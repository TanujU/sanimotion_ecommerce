          ...
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            {steps.map((step, index) => (
              <div key={step.id} className="flex items-center">
                <span className={index <= currentStepIndex ? 'text-blue-600' : 'text-gray-400'}>
                  {step.name}
                </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium mb-2">Land/Region</label>
                  <select
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium mb-2">Vorname (optional)</label>
                    <input
                      type="text"
                ...
                <div>
                  <label className="block text-sm font-medium mb-2">Wohnung, Suite, etc. (optional)</label>
                  <input
                    type="text"
            ...
            <div className="flex justify-between">
              ...
              >
                {currentStep === 'information' ? 'Weiter zum Versand' : 
                 currentStep === 'shipping' ? 'Weiter zur Zahlung' : 'Bestellung abschließen'}
              </button>
            </div>
          </div>
